...
public class DownloadVMI {
	...
	public static void main(String[] args) throws ExecutionException, InterruptedException, URISyntaxException {
		...
		String vmImageName = "mysql-disk1.vmdk"; 
		
		try{
			long startTime = System.currentTimeMillis();
	        long elapsedTime = 0L ;
	        
			URI uri = new URI("https://s3.tnode.com:9869/flexiant-entice/mysql-disk1.vmdk");			
			download.downloadVMIViaURI(uri, new File("D:\\projects\\lpt\\entice-ul-api\\" + vmImageName));
