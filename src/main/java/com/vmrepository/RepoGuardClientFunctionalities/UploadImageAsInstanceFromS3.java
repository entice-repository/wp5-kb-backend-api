...
public class UploadImageAsInstanceFromS3 {
    ...
    public static void main(String[] args) {
        try {
            uploadImageAsInstanceFromS3("LJUBLJANA", "hyp!w7cUNkd$rd_V", "Lamp.qcow2", "OpenStack", "http://192.168" + ".64.170:8080/v1/AUTH_290f044a9121415fa09a6d518d4ee084/ljubljana/Lamp.qcow2");
        } catch (IOException e) {
            e.printStackTrace();
