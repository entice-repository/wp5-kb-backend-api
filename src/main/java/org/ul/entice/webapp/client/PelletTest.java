...
public class PelletTest {
    ...
    private static final String BASE_URL_ENTICE = "http://193.2.72.90:3030/entice-mo";
    ...
    public static void main(String args[]) {
        try {
           // executeWorkingReasoningTest(BASE_URL);
            ...
            OWLClass fragmentClass = factory.getOWLClass("knowledgebase:Repository", pm);
            System.out.println("-- Found all fragments:");

            OWLNamedIndividual someFragment = null;
            for (OWLNamedIndividual repo : reasoner.getInstances(fragmentClass, true).getFlattened()) {
