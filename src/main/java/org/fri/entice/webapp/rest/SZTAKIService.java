...
//            String jsonContent = CommonUtils.readFile("D:\\projects\\lpt\\entice-ul-api\\internal_work\\input_test.json", StandardCharsets.UTF_8);
            ...
            SZTAKIExecuteObj sztakiExecuteObj = new SZTAKIExecuteObj("ami-00001483", "http://s3.lpds.sztaki" +
                    ".hu/atisu/entice/wp3/wordpress-centos7.0-20160627a.qcow", "root", "ahajnal_keypair",
