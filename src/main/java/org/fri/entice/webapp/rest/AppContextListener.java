...
//        }
        ...
        try {
            ...
            ///////// TEST
            /*
            List<Repository> repositoryList = FusekiUtils.getAllEntityAttributes(Repository.class,". ?s knowledgebase:Repository_Space ?space . FILTER (?space >= 130) ");

            for(Repository repository : repositoryList){
                System.out.println(repository.getSpace());
            }
